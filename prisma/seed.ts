...
async function main() {
	...
	const tags = await prisma.tag.createMany({
		data: [
			...
			{ name: "plugins" },
			{ name: "music" }, */
			{ id: nanoid(5), name: "lol" },
			{ id: nanoid(5), name: "web" },
			{ id: nanoid(5), name: "gear" },
			{ id: nanoid(5), name: "portfolio" },
			{ id: nanoid(5), name: "software" },
			{ id: nanoid(5), name: "art" },
			{ id: nanoid(5), name: "plugins" },
			{ id: nanoid(5), name: "music" },
		],
	})
	console.log({ tags })
}
