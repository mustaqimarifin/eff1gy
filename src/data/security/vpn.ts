  ...
  \n\nYou should use a VPN provider that you trust to not harvest and re-sell your data. The best VPNs often charge a monthly subscription - this is a good thing because it means their business model is not reliant upon reselling your data to advertisers.
    ...
    apps: [
        ...
        },
        {
            ...
            sources: {
                windows:
                    'https://app.encrypt.me/transition/download/windows/latest/',
        ...
        },
        {
            ...
            sources: {
                ...
                linux: 'https://www.expressvpn.com/support/vpn-setup/manual-config-for-linux-with-openvpn/',
            },
        },
        {
            name: 'NordVPN',
        ...
        },
        {
            ...
            sources: {
                ...
                macos: 'https://www.privateinternetaccess.com/installer/x/download_installer_osx',
                ...
                linux: 'https://www.privateinternetaccess.com/installer/x/download_installer_linux',
            },
        },
        {
            name: 'PureVPN',
