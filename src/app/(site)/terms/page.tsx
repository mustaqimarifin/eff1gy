		...
		<TOS>
			<Detail.ContentContainer>
				<div className="space-y-8 pb-24 md:space-y-16">
					<div className="dark:prose-invert prose mx-auto flex max-w-2xl flex-col items-start justify-start pb-16 text-left  text-gray-600 prose-headings:font-bold dark:text-gray-300">
						<h1 className="mt-8 flex leading-7  transition-all hover:text-gray-800 dark:hover:text-gray-200  ">
							Terms of Service
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="ml-1 h-10 w-8">
								<path
									stroke="currentColor"
									strokeLinecap="round"
						...
						<ul>
							...
							<li>
								<p>
									...
									&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Mustaqim Arifin.
								</p>
							</li>
							<li>
								<p>
							...
							<li>
								<p>
									<strong>Website</strong> refers to Mustaqim Arifin, accessible from{" "}
									<a href="https://eff1gy.vercel.app" rel="external nofollow noopener noreferrer" target="_blank">
						...
						<h2>Contact Us</h2>
						<p>If you have any questions about these Terms and Conditions, You can contact:</p>
						<p>
