...
export type BookmarkDetailFragment_Bookmark_tags_Tag = (
  { name: string }
  & { __typename?: 'Tag' }
);

export type BookmarkDetailFragment = (
  { reactionCount?: number | null, viewerHasReacted?: boolean | null, id: string, url?: string | null, host: string, title?: string | null, description?: string | null, faviconUrl?: string | null, count?: number | null, tags: Array<BookmarkDetailFragment_Bookmark_tags_Tag | null> }
  & { __typename: 'Bookmark' }
);
...
export type CommentInfoFragment = (
  { id: string, parentId?: string | null, createdAt: any, updatedAt?: any | null, text?: string | null, viewerCanEdit?: boolean | null, viewerCanDelete?: boolean | null, author: CommentInfoFragment_Comment_author_User }
  & { __typename: 'Comment' }
);
...
export type QuestionDetailFragment = (
  { description?: string | null, status?: QuestionStatus | null, viewerCanEdit?: boolean | null, viewerCanComment?: boolean | null, reactionCount?: number | null, viewerHasReacted?: boolean | null, id: string, title: string, audioUrl?: string | null, waveform?: any | null, count?: number | null, createdAt: any, author?: CommentInfoFragment_Comment_author_User | null }
  & { __typename: 'Question' }
);

export type QuestionCoreFragment = (
  { id: string, title: string, audioUrl?: string | null, waveform?: any | null, count?: number | null, createdAt: any, author?: CommentInfoFragment_Comment_author_User | null }
  & { __typename: 'Question' }
);

export type StackDetailFragment = (
  { createdAt: any, description?: string | null, reactionCount?: number | null, viewerHasReacted?: boolean | null, usedByViewer?: boolean | null, id: string, name: string, image?: string | null, url: string, slug: string, count?: number | null, usedBy: Array<CommentInfoFragment_Comment_author_User | null>, tags: Array<BookmarkDetailFragment_Bookmark_tags_Tag | null> }
  & { __typename: 'Stack' }
);
...
export type BookmarksConnectionFragment_BookmarksConnection_edges_BookmarkEdge = (
  { cursor?: string | null, node?: BookmarksConnectionFragment_BookmarksConnection_edges_BookmarkEdge_node_Bookmark | null }
  & { __typename?: 'BookmarkEdge' }
);

export type BookmarksConnectionFragment = (
  { pageInfo?: BookmarksConnectionFragment_BookmarksConnection_pageInfo_PageInfo | null, edges: Array<BookmarksConnectionFragment_BookmarksConnection_edges_BookmarkEdge | null> }
  & { __typename?: 'BookmarksConnection' }
);
...
export type QuestionsConnectionFragment_QuestionsConnection_edges_QuestionEdge = (
  { cursor?: string | null, node?: QuestionsConnectionFragment_QuestionsConnection_edges_QuestionEdge_node_Question | null }
  & { __typename?: 'QuestionEdge' }
);

export type QuestionsConnectionFragment = (
  { pageInfo?: BookmarksConnectionFragment_BookmarksConnection_pageInfo_PageInfo | null, edges: Array<QuestionsConnectionFragment_QuestionsConnection_edges_QuestionEdge | null> }
  & { __typename?: 'QuestionsConnection' }
);
...
export type StacksConnectionFragment_StacksConnection_edges_StackEdge = (
  { cursor?: string | null, node?: StacksConnectionFragment_StacksConnection_edges_StackEdge_node_Stack | null }
  & { __typename?: 'StackEdge' }
);

export type StacksConnectionFragment = (
  { pageInfo?: BookmarksConnectionFragment_BookmarksConnection_pageInfo_PageInfo | null, edges: Array<StacksConnectionFragment_StacksConnection_edges_StackEdge | null> }
  & { __typename?: 'StacksConnection' }
);
...
export type EditBookmarkMutation_editBookmark_Bookmark = (
  { id: string, url?: string | null, host: string, title?: string | null, description?: string | null, faviconUrl?: string | null, count?: number | null, reactionCount?: number | null, viewerHasReacted?: boolean | null, tags: Array<BookmarkDetailFragment_Bookmark_tags_Tag | null> }
  & { __typename: 'Bookmark' }
);

export type EditBookmarkMutation_Mutation = (
  { editBookmark?: EditBookmarkMutation_editBookmark_Bookmark | null }
  & { __typename?: 'Mutation' }
);
...
export type DeleteBookmarkMutation_Mutation = (
...
export type AddBookmarkMutation_Mutation = (
  { addBookmark?: EditBookmarkMutation_editBookmark_Bookmark | null }
  & { __typename?: 'Mutation' }
);
...
export type AddCommentMutation_Mutation = (
  { addComment?: AddCommentMutation_addComment_Comment | null }
  & { __typename?: 'Mutation' }
);
...
export type EditCommentMutation_Mutation = (
  { editComment?: AddCommentMutation_addComment_Comment | null }
  & { __typename?: 'Mutation' }
);
...
export type DeleteCommentMutation_Mutation = (
...
export type EditPostMutation_Mutation = (
  { editPost?: EditPostMutation_editPost_Post | null }
  & { __typename?: 'Mutation' }
);
...
export type DeletePostMutation_Mutation = (
...
export type AddPostMutation_Mutation = (
  { addPost?: EditPostMutation_editPost_Post | null }
  & { __typename?: 'Mutation' }
);
...
export type EditQuestionMutation_editQuestion_Question = (
  { id: string, title: string, audioUrl?: string | null, waveform?: any | null, count?: number | null, createdAt: any, description?: string | null, status?: QuestionStatus | null, viewerCanEdit?: boolean | null, viewerCanComment?: boolean | null, reactionCount?: number | null, viewerHasReacted?: boolean | null, author?: CommentInfoFragment_Comment_author_User | null }
  & { __typename: 'Question' }
);

export type EditQuestionMutation_Mutation = (
  { editQuestion?: EditQuestionMutation_editQuestion_Question | null }
  & { __typename?: 'Mutation' }
);
...
export type DeleteQuestionMutation_Mutation = (
...
export type AddQuestionMutation_Mutation = (
  { addQuestion?: EditQuestionMutation_editQuestion_Question | null }
  & { __typename?: 'Mutation' }
);
...
export type ToggleReactionMutation_toggleReaction = ToggleReactionMutation_toggleReaction_BKyHqGdoFdS0AN6p04a0wRih3RXybe8RXjEGPenvWU8 | ToggleReactionMutation_toggleReaction_Bookmark | ToggleReactionMutation_toggleReaction_Post;

export type ToggleReactionMutation_Mutation = (
  { toggleReaction?: ToggleReactionMutation_toggleReaction | null }
  & { __typename?: 'Mutation' }
);
...
export type EditStackMutation_editStack_Stack = (
  { id: string, name: string, image?: string | null, url: string, slug: string, count?: number | null, createdAt: any, description?: string | null, reactionCount?: number | null, viewerHasReacted?: boolean | null, usedByViewer?: boolean | null, usedBy: Array<CommentInfoFragment_Comment_author_User | null>, tags: Array<BookmarkDetailFragment_Bookmark_tags_Tag | null> }
  & { __typename: 'Stack' }
);

export type EditStackMutation_Mutation = (
  { editStack?: EditStackMutation_editStack_Stack | null }
  & { __typename?: 'Mutation' }
);
...
export type DeleteStackMutation_Mutation = (
...
export type AddStackMutation_Mutation = (
  { addStack?: EditStackMutation_editStack_Stack | null }
  & { __typename?: 'Mutation' }
);
...
export type ToggleStackUserMutation_toggleStackUser_Stack = (
  { id: string, name: string, image?: string | null, url: string, slug: string, count?: number | null, usedBy: Array<CommentInfoFragment_Comment_author_User | null> }
  & { __typename: 'Stack' }
);
...
export type DeleteUserMutation_Mutation = (
...
export type EditUserMutation_Mutation = (
  { editUser?: CommentInfoFragment_Comment_author_User | null }
  & { __typename?: 'Mutation' }
);
...
export type AddViewMutation_addView = AddViewMutation_addView_eehSljCDzEEcfNMHqRY9v5qecvDbkm6GKd0g0pNSfcE | AddViewMutation_addView_Case_Event_Post;

export type AddViewMutation_Mutation = (
...
export type GetBlogsQuery_Query = (
  { blogs: Array<GetBlogsQuery_blogs_Blog | null> }
  & { __typename?: 'Query' }
);
...
export type GetBlogQuery_Query = (
  { blog?: GetBlogQuery_blog_Blog | null }
  & { __typename?: 'Query' }
);
...
export type GetBookmarksQuery_Query = (
  { bookmarks: GetBookmarksQuery_bookmarks_BookmarksConnection }
  & { __typename?: 'Query' }
);
...
export type GetBookmarkQuery_Query = (
  { bookmark?: EditBookmarkMutation_editBookmark_Bookmark | null }
  & { __typename?: 'Query' }
);
...
export type GetCasesQuery_Query = (
  { cases: Array<GetCasesQuery_cases_Case | null> }
  & { __typename?: 'Query' }
);
...
export type GetCaseQuery_Query = (
  { case?: GetCaseQuery_case_Case | null }
  & { __typename?: 'Query' }
);
...
export type GetCommentsQuery_Query = (
  { comments: Array<AddCommentMutation_addComment_Comment | null> }
  & { __typename?: 'Query' }
);
...
export type GetPostsQuery_Query = (
  { posts: Array<GetPostsQuery_posts_Post | null> }
  & { __typename?: 'Query' }
);
...
export type GetPostQuery_Query = (
  { post?: EditPostMutation_editPost_Post | null }
  & { __typename?: 'Query' }
);
...
export type GetQuestionsQuery_Query = (
  { questions: GetQuestionsQuery_questions_QuestionsConnection }
  & { __typename?: 'Query' }
);
...
export type GetQuestionQuery_Query = (
  { question?: EditQuestionMutation_editQuestion_Question | null }
  & { __typename?: 'Query' }
);
...
export type GetStacksQuery_Query = (
  { stacks: GetStacksQuery_stacks_StacksConnection }
  & { __typename?: 'Query' }
);
...
export type GetStackQuery_Query = (
  { stack?: EditStackMutation_editStack_Stack | null }
  & { __typename?: 'Query' }
);
...
export type GetUserQuery_Query = (
  { user?: CommentInfoFragment_Comment_author_User | null }
  & { __typename?: 'Query' }
);
...
export type ViewerQuery_Query = (
  { viewer?: CommentInfoFragment_Comment_author_User | null }
  & { __typename?: 'Query' }
);
...
export type GetViewerWithSettingsQuery_Query = (
  { viewer?: GetViewerWithSettingsQuery_viewer_User | null }
  & { __typename?: 'Query' }
);
