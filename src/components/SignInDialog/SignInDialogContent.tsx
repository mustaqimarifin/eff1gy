  ...
  return (
    <>
      <div
        ...
        className="z-40 flex flex-col items-center space-y-6 p-8 md:p-6"
      >
        <div className="text-primary grid w-full grid-cols-2 gap-4">
    ...
    >
      ...
      />
          ...
          <div className="flex flex-col items-center justify-center space-y-2 rounded-lg bg-gray-100 p-4 dark:bg-gray-700 dark:bg-opacity-70">
            <div className="w-25 container flex justify-center ">
              <Image
    ...
    >
      ...
      />
        ...
        <div className="flex items-stretch justify-items-stretch gap-4 self-stretch">
          <Link className="flex w-full" href="/api/auth/signin/google">
            <TwitterButton
              onClick={(e) => {
                e.preventDefault()
                signIn('twitter')
