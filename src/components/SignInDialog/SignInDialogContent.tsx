...
export function SignInDialogContent() {
    return (
        ...
        >
            ...
            <div className="flex items-stretch justify-center space-x-6 self-stretch p-4 md:p-6">
                ...
                <Link className="flex w-full" href="/api/auth/signin/twitter">
                    <TwitterButton
                        onClick={(e) => {
                            e.preventDefault()
                            signIn('twitter')
            ...
            <p className="text-quaternary text-left text-xs">
                ...
                public Twitter profile information. You won’t be subscribed to
                anything.
            </p>
        </div>
    )
