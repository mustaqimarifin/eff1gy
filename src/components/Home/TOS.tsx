    ...
    <Detail.Container data-cy="pp" ref={scrollContainerRef}>
      <Detail.ContentContainer>
        <div className="pb-24 space-y-8 md:space-y-16">
          ...
          <div className="prose mx-auto flex max-w-2xl flex-col items-start justify-start pb-16 text-left text-gray-600  prose-headings:font-bold dark:prose-invert dark:text-gray-300">
