...
function TableRow({ href, title, subtitle, date }: TableRowProps) {
    return (
        ...
        >
            ...
            {subtitle && (
                <span className="text-tertiary flex-none">{subtitle}</span>
            )}
            {date && (
                <span className="text-quaternary flex-none font-mono">
                    {date}
                </span>
            )}
        </a>
                        ...
                        <article className="layout w-full p-2 lg:max-w-3xl">
                            ...
                            <div className="drop-shadow-sm">
                                <p className="dark:prose-dark prose max-w-none break-words py-4 md:prose-lg">
                                    A sizable portion of my career involves my
                                    work as an&nbsp;
                                    ...
                                    Akhyla - a platform to electronic musicians
                                    to learn, collaborate and make records.And
                                    in between that time was Music Director for
                                    Infinity Games working on MMORPG, Heroes of
                                    War.
                                </p>
                                <p className="dark:prose-dark prose py-4 leading-loose md:prose-lg">
                                    This website is my home on the web to share
                                    my thoughts, test my web development skills,
                                    keep a record of my work, and catalog the
