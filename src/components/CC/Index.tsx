...
export function CCPage({ children }) {
	const scrollContainerRef = useRef(null);
	const titleRef = useRef(null);

	return (
		<Detail.Container data-cy="cc-detail" ref={scrollContainerRef}>
			<TitleBar magicTitle titleRef={titleRef} scrollContainerRef={scrollContainerRef} title="CC" />
