...
export function EmailForm(props: {
    ...
    const [cancelPendingEmail, cancelPendingEmailResponse] =
        useEditUserMutation({
            variables: {
                data: {
                    email: null,
    ...
    const [resendPendingEmail, resendPendingEmailResponse] =
        useEditUserMutation({
            variables: {
                data: {
                ...
                <form className="space-y-2" onSubmit={onSubmit}>
                    {isNew && (
                        <p className="text-quaternary text-sm">
                            Adding your email will allow you to turn on replies
                            for comments or AMA questions.
                        </p>
                    )}
                    <Input
                        type="email"
