                ...
                <form className="space-y-2" onSubmit={onSubmit}>
                    ...
                    {error && (
                        <p className={`text-error text-xs`}>
                            Usernames should be between 4 and 16 characters and
                            only have numbers, letters, or underscores.
                        </p>
                    )}
                    <p className="text-quaternary text-xs">
                        Updating your name will break any existing links to your
                        profile, so you know, don’t do it too often.
                    </p>
                    <div className="flex justify-between">
                        <Button type="submit">
                            {editUserResponse.loading ? (
                                <LoadingSpinner />
                            ) : (
                                'Save name'
                            )}
